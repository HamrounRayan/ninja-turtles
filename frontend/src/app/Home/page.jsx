  ...
  px-6 md:px-20 py-3">
        <div className="max-w-[1280px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="/login"><  button className="flex items-center gap-2 rounded-lg border border-[#e7d7cf]  px-4 py-2 text-sm font-bold hover:bg-gray-50 hover:text-black  transition-all">
              Log in 
            </button></a>
            ...
            <div className="p-6 flex flex-col flex-1">
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-500">
                  Location: <span className="text-black">{project.address}</span>
                </div>
              </div>

              <div className="mt-auto flex flex-col gap-4">
                <a href="/Forms"><button className="w-full bg-[#00695C] text-white py-3 rounded-xl font-bold border-2 border-[#00695C] hover:bg-white hover:text-[#00695C] transition-all">
                  Volunteer
                </button></a>
